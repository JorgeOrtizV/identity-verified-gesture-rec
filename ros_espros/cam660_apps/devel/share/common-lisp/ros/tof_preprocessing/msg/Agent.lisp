...
(cl:defmethod cl:initialize-instance :after ((m <Agent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Agent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tof_preprocessing-msg:<Agent> is deprecated: use tof_preprocessing-msg:Agent instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Agent>))
...
(cl:defmethod state-val ((m <Agent>))
